...
namespace ProductSupplier.Controllers
    ...
    public class ProductController : Controller
        ...
        public ActionResult SupplierProductAverage()
            ...
            {
                prodSuppliers.AddRange(product.Prices);
            }
            ...
            return View(viewModel);// Complete this line......
        }
        ...
        {
            List<Product> products = (List<Product>)ListRepository.Products.Where(x => 
            (x.Prices.Average(y => y.Price) >= min) && 
            (x.Prices.Average(y => y.Price) <= max)).ToList();
